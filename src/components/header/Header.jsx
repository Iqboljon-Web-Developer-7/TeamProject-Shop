      ...
      <div className=" container mx-auto px-5">
       ...
       flex items-center justify-between"
        >
          ...
          <div
            className="  bg-white rounded-md search__bag dark:bg-black
...
"
          ...
          >
            <div
              onClick={toggleMenu}
              className="navbar__menu  cursor-pointer text-2xl text-white"
            >
            ...
            <ul className="navbar__collection flex gap-4   dark:text-white dark:bg-black p-3 	">
              <NavLink
                className={
                  " text-black dark:text-white  flex gap-1 items-center"
                }
                to={"/wishlist"}
              >
